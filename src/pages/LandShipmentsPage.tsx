              ...
              <TableBody>
                {shipments.map((shipment) => (
                  <TableRow key={shipment.id}>
                    ...
                    <TableCell>{shipment.destinationWarehouseName}</TableCell>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center" onClick={() => setDetailModalOpen(false)}>
          <div className="bg-white rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            <div className="bg-primary text-primary-foreground p-4 rounded-t-lg">
              <h2 className="text-lg font-semibold">Detalles del Envío Terrestre</h2>
            ...
            <div className="p-4 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-muted rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">Placa Vehículo</p>
              ...
              <div className="p-3 bg-muted rounded-lg">
                <p className="text-xs text-muted-foreground mb-1">Bodega de Destino</p>
                <p className="font-medium">{selectedShipment.destinationWarehouseName}</p>
              </div>
